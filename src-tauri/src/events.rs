...
use crate::models::{LiveMetrics, RunErrorEvent, RunMetricsEvent, TestCompletion};
...
pub fn emit_k6_metrics(app: &AppHandle, run_id: &str, payload: LiveMetrics) -> tauri::Result<()> {
    app.emit_to(
        MAIN_WINDOW_LABEL,
        K6_METRICS_EVENT,
        RunMetricsEvent {
...
pub fn emit_k6_error(app: &AppHandle, run_id: &str, payload: &str) -> tauri::Result<()> {
    app.emit_to(
        MAIN_WINDOW_LABEL,
        K6_ERROR_EVENT,
        RunErrorEvent {

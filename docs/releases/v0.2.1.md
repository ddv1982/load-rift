...
- Linux AppImage: attached to this GitHub release as `Load.Rift_0.2.1_amd64.AppImage`
- Linux `.deb`: attached to this GitHub release as `Load.Rift_0.2.1_amd64.deb`
- Linux `.rpm`: attached to this GitHub release as `Load.Rift-0.2.1-1.x86_64.rpm`
